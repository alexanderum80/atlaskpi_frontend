...
import {
    ITargetNew, ITargetUser, ITargetNotificationConfig, SourceNew, DateRangeNew, ReportOptionsNew, IDeliveryMethod
...
export class deliveryMethodViewModel extends ViewModel<IDeliveryMethod> {
    ...
    public initialize(model: IDeliveryMethod): void {
        this.onInit(model);
    }
}
...
export class UserViewModel extends ViewModel<ITargetUser> {
    ...
    public initialize(model: ITargetUser): void {
        this.onInit(model);
    }
}

export class NotifyViewModel extends ViewModel<ITargetNotificationConfig> {

    @Field({ type: Number })
    notifiOnPercentage: number;

    @Field({ type: UserViewModel })
    users: [ITargetUser];

    public initialize(model: ITargetNotificationConfig): void {
        this.onInit(model);
    }
}
