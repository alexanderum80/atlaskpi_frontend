...
import { Field, ViewModel, ArrayField } from '../../../ng-material-components/viewModels';
import { ICustomSchemaInfo, ICustomDataInfo, ICustomSchema, IDataType } from '../../shared/models/data-entry-form.model';
...
export class CustomFormViewModel extends ViewModel<ICustomSchema> {
    ...
    constructor() {
        ...
        this._defaultSchema = {
            schema: [
                { columnName: 'Invoice amount', dataType: this._dataType.number, required: false},
                { columnName: 'Due Date', dataType: this._dataType.date, required: false },
        ...
        this._defaultInputSchema = {
            schema : [
                { columnName: '', dataType: this._dataType.number, required: false },
                { columnName: '', dataType: this._dataType.date, required: false },
                { columnName: '', dataType: this._dataType.string, required: false },
            ],
            data: [],
            dataName: '',
            dateRangeField: '1'
